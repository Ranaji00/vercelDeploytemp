    ...
    return (
        ...
        <div className='w-full border-2 relative z-0 flex justify-center items-center h-1/2 md:h-1/3 py-2'>
            <div className="grid grid-cols-3 gap-2 mx-auto  py-4 ">
                ...
                <Link to={'/collection'} className='border-2 rounded-3xl  relative text-white bg-[#a1a4ac]  px-6 col-span-2 flex justify-between items-center'>
                    <div className='w-1/3 md:w-1/2 text-sm  md:text-4xl  font-bold'>
                        ...
                        <p className=' font-medium text-xs md:text-xl w-[12rem]  text-zinc-600 md:w-96 '> Newly Lauched HeadPhone 20mm Driver, Latest BT ver-5.4 </p>
                    </div>
                ...
                <Link to={'/collection'} className='relative rounded-3xl '>
